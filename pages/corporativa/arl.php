        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Gestion de ARL</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="#"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item"><a href="#">ARL</a></li>
            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <div class="row icon-examples">
				...
				<button  type="button" class="btn btn-primary btn-lg btn-block" onclick="location.href=&quot;nuevoarl.php&quot;">
                ...
                <div style="padding-top: 15px;"class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-warning btn-lg btn-block" onclick="location.href=&quot;modificararl.php&quot;">
				 <div>
                      <i class="ni ni-settings-gear-65 "></i>
                      <span>Modificar ARL</span>
                    </div>
				  </button>
                </div>
				
				 <div style="padding-top: 15px;" class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-danger btn-lg btn-block" onclick="location.href=&quot;eliminararl.php&quot;">
				  <div>
                      <i class="ni ni-fat-remove "></i>
                      <span>Eliminar ARL</span>
                    </div>
				  </button>
                </div>
...
<div class="card">
            ...
            <div class="card-body">
              <div class="row align-items-center">
                <div class="col-auto">
                  <!-- Avatar -->
                  <a href="#" id="avata" class="avatar avatar-xl rounded-circle">
                    <img src="../../uploads/arl/<?php echo $foto;?>">
                  </a>
                </div>
                <div class="col ml--2">
                  <h4 class="mb-0">
                  ...
                  <p class="text-sm text-muted mb-0">CODIGO: <?php echo $codigo;?></p>
                  <span class="text-success">●</span>
                  <small>Activo</small>
                </div>
                <div class="col-auto">
                  <button type="button" onclick="location.href='verarl.php?valor=<?php echo $rov['id_arl'] ?>'" class="btn btn-sm btn-success">Ver</button>
                </div>
              </div>
            </div>
          </div>
