...
<body>
 ...
 <?php require('../general/nav.php')?>
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Nuevo cargo</h6>
          ...
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <div class="card-header">
			   ...
			   <form class="needs-validation" novalidate enctype="multipart/form-data" method="post"  action="nuevoguardarcargo.php">
              <!-- Card body -->
              <div class="card-body">
  ...
  <div class="form-row">
                  ...
                  <button class="btn btn-primary btn-lg btn-block"  type="submit">AGREGAR CARGO</button>
                </form>
              </div>
            </div>
