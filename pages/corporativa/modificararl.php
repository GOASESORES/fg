            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <div class="row icon-examples">
                ...
                <div style="padding-top: 15px;"class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-success btn-lg btn-block" onclick="location.href=&quot;arl.php&quot;">
				 <div>
                      <i class="ni ni-single-02 "></i>
                      <span>Ver ARL</span>
                    </div>
...
<div class="card">
            ...
            <div class="card-body">
              <div class="row align-items-center">
                ...
                <div class="col-auto">
                  <button type="button" onclick="location.href='editararl.php?valor=<?php echo $rov['id_arl'] ?>'" class="btn btn-sm btn-warning">Editar</button>
                </div>
              </div>
            </div>
          </div>
