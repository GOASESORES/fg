...
<body>
 ...
 <nav class="sidenav navbar navbar-vertical  fixed-left  navbar-expand-xs navbar-light bg-white" id="sidenav-main">
    <div class="scrollbar-inner">
	  ...
	  <style>
	  #ajuste{
		   background-image: url('../../uploads/clientes/5dc9e9238dc9f.png');
                ...
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="../examples/pricing.html" class="nav-link">
                      <span class="sidenav-mini-icon"> GA </span>
                  ...
                  <li class="nav-item">
                    <a href="../examples/timeline.html" class="nav-link">
                      <span class="sidenav-mini-icon"> GE </span>
                  ...
                  <li class="nav-item">
                    <a href="../examples/rtl-support.html" class="nav-link">
                      <span class="sidenav-mini-icon"> GU </span>
                      <span class="sidenav-normal"> Gestion Usuarios </span>
                    </a>
                  </li>
				  <li class="nav-item">
                    <a href="../corporativa/index.php" class="nav-link">
                      <span class="sidenav-mini-icon"> GC </span>
				  ...
				  <li class="nav-item">
                    <a href="../examples/rtl-support.html" class="nav-link">
                      ...
                      <span class="sidenav-normal"> Factores personales </span>
                    </a>
                  </li>
				  <li class="nav-item">
                    <a href="../examples/rtl-support.html" class="nav-link">
                      <span class="sidenav-mini-icon"> FT </span>
                      <span class="sidenav-normal"> Factores trabajo </span>
                    </a>
                  </li>
				  <li class="nav-item">
                    <a href="../examples/rtl-support.html" class="nav-link">
                      <span class="sidenav-mini-icon"> GG </span>
                      <span class="sidenav-normal"> Gestion Grupos </span>
                    </a>
                  </li>
				  				  <li class="nav-item">
                    <a href="../examples/rtl-support.html" class="nav-link">
                      <span class="sidenav-mini-icon"> GF </span>
                      <span class="sidenav-normal"> Gestion Fondos </span>
                    </a>
                  </li>
                </ul>
              </div>
              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  <span class="avatar avatar-sm rounded-circle">
                    <img alt="Image placeholder" src="../../uploads/usuarios/<?php echo $user->getfoto();  ?>">
                  </span>
            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <div class="row icon-examples">
				...
				<button  type="button" class="btn btn-primary btn-lg btn-block" onclick="location.href=&quot;nuevousuario.php&quot;">
				...
				<div style="padding-top: 15px;" class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-danger btn-lg btn-block" onclick="location.href=&quot;modificarusuario.php&quot;">
				  <div>
                      <i class="ni ni-fat-settings-gear-65 "></i>
                ...
                <div style="padding-top: 15px;"class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-success btn-lg btn-block" onclick="location.href=&quot;usuarios.php&quot;">
				 <div>
                      <i class="ni ni-single-02  "></i>
...
$quera="SELECT * FROM usuario WHERE state_fsc='activo' AND empresa='$empresa' ORDER BY `usuario`.`id_usuario` DESC";
$caa=$mysqli->query($quera);
while($rov=$caa->fetch_assoc()){
	$id=$rov['id_usuario'];
$nombre=$rov['nombre'];
$apellido=$rov['apellido'];
$cedula=$rov['cedula'];
$foto=$rov['foto'];
$centro=$rov['centro'];
              ...
              <div class="row align-items-center">
                <div class="col-auto">
                  ...
                  <a href="#" id="foto" class="avatar avatar-xl ">
                    <img src="../../uploads/usuarios/<?php echo $foto;?>">
                  </a>
                </div>
                <div class="col ml--2">
                  <h4 class="mb-0">
				   ...
				   <h4 class="mb-0">
                    <a href="#!"><?php echo $apellido;?></a>
                  </h4>
                  <p class="text-sm text-muted mb-0">CC: <?php echo $cedula;?></p>
				  <p class="text-sm text-muted mb-0">Centro: <?php echo $centro;?></p>
...
#qr {
    ...
    justify-content: center;
				  ...
				  <p class="text-sm text-muted mb-0"><a href="#" id="qr"class="avatar avatar-xl ">
				 
                    <img src="../../uploads/usuarios/qr/<?php echo $id;?>.png">
                  </a></p>
                  <button type="button" onclick="location.href='delateusuario.php?valor=<?php echo $rov['id_usuario'] ?>'" class="btn btn-sm btn-danger">Eliminar</button>
                </div>
              </div>
            </div>
          </div>
