              ...
              <div class="card-body">
               ...
               <div class="row icon-examples">
                ...
                <div style="padding-top: 15px;"class="col-lg-4 col-md-6">
				 ...
				 <div style="padding-top: 15px;" class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-danger btn-lg btn-block" onclick="location.href=&quot;eliminargrupo.php&quot;">
				  <div>
...
#qr {
    ...
    justify-content: center;
                  ...
                  <button type="button" onclick="location.href='vergrupo.php?valor=<?php echo $rov['id_grupo'] ?>'" class="btn btn-sm btn-success">Ver</button>
                </div>
              </div>
            </div>
          </div>
