            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <div class="row icon-examples">
                ...
                <div style="padding-top: 15px;"class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-warning btn-lg btn-block" onclick="location.href=&quot;modificarusuario.php&quot;">
				 <div>
                      <i class="ni ni-settings-gear-65 "></i>
				 ...
				 <div style="padding-top: 15px;" class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-danger btn-lg btn-block" onclick="location.href=&quot;eliminarusuario.php&quot;">
				  <div>
...
#qr {
    ...
    justify-content: center;
                  ...
                  <button type="button" onclick="location.href='usuariover.php?valor=<?php echo $rov['id_usuario'] ?>'" class="btn btn-sm btn-success">Ver</button>
                </div>
              </div>
            </div>
          </div>
