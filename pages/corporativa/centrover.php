...
<input name="nombre" type="text" class="form-control" id="validationCustom02" placeholder="Apellidos"  value="<?php echo $rov['nombre']?>" readonly required>
                      
                    </div>
					 <div class="col-md-4 mb-3">
                      <label class="form-control-label" for="validationCustom02">C. costos</label>
                      <input name="costos" type="text" class="form-control" id="validationCustom02" value="<?php echo $rov['costos']?>" readonly placeholder="Nombre"  required>
                      
                    </div>
					 <div class="col-md-4 mb-3">
                      <label class="form-control-label" for="validationCustom02">Ciudad</label>
                      <input name="ciudad" type="text" class="form-control" id="validationCustom02" value="<?php echo $rov['ciudad']?>" readonly placeholder="Nombre"  required>
                      
                    </div>
					 <div class="col-md-4 mb-3">
                      <label class="form-control-label" for="validationCustom02">Direccion</label>
                      <input name="direccion" type="text" class="form-control" id="validationCustom02" placeholder="Nombre" value="<?php echo $rov['direccion']?>" readonly  required>
                      
                    </div>
					<div class="col-md-4 mb-3">
                      <label class="form-control-label" for="validationCustom02">responsable</label>
                      <input name="responsable" type="text" placeholder="Responsable" class="form-control" id="validationCustom02"  value="<?php echo $rov['responsable']?>" readonly  required>
                     
                    </div>
					  
					<div class="col-md-4 mb-3">
                      <label class="form-control-label" for="validationCustom02" >cargo</label>
                    <select class="form-control" name="cargo" required readonly>
...
<?php } ?>
                  ...
                  <button class="btn btn-primary btn-lg btn-block"  onclick="location.href='centros.php'" type="submit">VOLVER</button>
