               ...
               <div class="row icon-examples">
                ...
                <div style="padding-top: 15px;"class="col-lg-4 col-md-6">
				 ...
				 <div>
				  ...
				  <div style="padding-top: 15px;"class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-success btn-lg btn-block" onclick="location.href=&quot;eps.php&quot;">
				 <div>
                      <i class="ni ni-single-02 "></i>
                      <span>ver EPS</span>
                    </div>
...
<div class="card">
            ...
            <div class="card-body">
              <div class="row align-items-center">
                ...
                <div class="col-auto">
                  <button type="button" onclick="location.href='deleteeps.php?valor=<?php echo $rov['id_eps'] ?>'" class="btn btn-sm btn-danger">Eliminar</button>
                </div>
              </div>
            </div>
          </div>
