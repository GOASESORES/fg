        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Modificar area</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
				  ...
				  <li class="breadcrumb-item"><a href="modificarareas.php">Modificar</a></li>
...
$valor=$_GET['valor'];
$quera="SELECT * FROM area WHERE id_area='$valor'";
...
$rov=$caa->fetch_assoc();
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <h3 class="mb-0">Datos de area</h3>
                 ...
                 <form class="needs-validation" novalidate enctype="multipart/form-data" method="post"  action="updateareas.php">
  ...
  <div class="form-row">
                <div class="col-md-4 mb-3">
                      ...
                      <input name="id" type="text" class="form-control" id="validationCustom02" value="<?php echo $rov['id_area']; ?>"  placeholder="id"   readonly required>
                  ...
                  <button class="btn btn-warning btn-lg btn-block"   type="submit">MODIFICAR AREA</button>
               </form>
              </div>
            </div>
