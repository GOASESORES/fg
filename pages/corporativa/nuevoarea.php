...
<body>
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Nueva area</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Nueva area</li>
                </ol>
              </nav>
            </div>
          ...
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <div class="card-header">
			   ...
			   <form class="needs-validation" novalidate enctype="multipart/form-data" method="post"  action="nuevoguardararea.php">
              <!-- Card body -->
              <div class="card-body">
  ...
  <div class="form-row">
                  ...
                  <button class="btn btn-primary btn-lg btn-block"  type="submit">AGREGAR AREA</button>
                </form>
              </div>
            </div>
