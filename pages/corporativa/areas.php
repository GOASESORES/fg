        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Gestion de areas</h6>
...
#qr {
    ...
    justify-content: center;
                  ...
                  <button type="button" onclick="location.href='verareas.php?valor=<?php echo $rov['id_area'] ?>'" class="btn btn-sm btn-success">Ver</button>
                </div>
              </div>
            </div>
          </div>
