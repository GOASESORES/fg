        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Gestion de clientes</h6>
            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <div class="row icon-examples">
				...
				<button  type="button" class="btn btn-primary btn-lg btn-block" onclick="location.href=&quot;nuevo.php&quot;">
                ...
                <div style="padding-top: 15px;"class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-success btn-lg btn-block" onclick="location.href=&quot;index.php&quot;">
				 <div>
                      <i class="ni ni-single-02 "></i>
                      <span>Ver un cliente</span>
                    </div>
				  </button>
                </div>
				
				  <div style="padding-top: 15px;"class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-warning btn-lg btn-block" onclick="location.href=&quot;modificar.php&quot;">
				 <div>
                      <i class="ni ni-settings-gear-65 "></i>
                      <span>Modificar un cliente</span>
                    </div>
				  </button>
                </div>
...
$quera="SELECT * FROM cliente WHERE state_fsc='activo' ORDER BY `cliente`.`id_cliente` DESC";
              ...
              <div class="row align-items-center">
                <div class="col-auto">
                  ...
                  <a href="#" class="avatar avatar-xl rounded-circle">
                    <img src="../../uploads/clientes/<?php echo $foto;?>">
                  </a>
                </div>
                <div class="col ml--2">
                  <h4 class="mb-0">
                  ...
                  <p class="text-sm text-muted mb-0">NIT: <?php echo $nit;?></p>
                  <span class="text-success">●</span>
                  <small>Activo</small>
                </div>
                <div class="col-auto">
                  <button type="button" onclick="location.href='borrar.php?valor=<?php echo $rov['id_cliente'] ?>'" class="btn btn-sm btn-danger">ELIMINAR</button>
                </div>
              </div>
            </div>
          </div>
