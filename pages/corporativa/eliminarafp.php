               ...
               <div class="row icon-examples">
                ...
                <div style="padding-top: 15px;"class="col-lg-4 col-md-6">
				 ...
				 <div>
				  ...
				  <div style="padding-top: 15px;"class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-success btn-lg btn-block" onclick="location.href=&quot;afp.php&quot;">
				 <div>
                      <i class="ni ni-single-02 "></i>
                      <span>ver AFP</span>
                    </div>
...
<div class="card">
            ...
            <div class="card-body">
              <div class="row align-items-center">
                ...
                <div class="col-auto">
                  <button type="button" onclick="location.href='deleteafp.php?valor=<?php echo $rov['id_afp'] ?>'" class="btn btn-sm btn-danger">Eliminar</button>
                </div>
              </div>
            </div>
          </div>
