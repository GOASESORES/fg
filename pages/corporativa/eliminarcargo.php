            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="eliminarcargo.php">Eliminar</a></li>
            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <div class="row icon-examples">
                ...
                <div style="padding-top: 15px;"class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-success btn-lg btn-block" onclick="location.href=&quot;cargos.php&quot;">
				 <div>
...
#qr {
    ...
    justify-content: center;
                  ...
                  <button type="button" onclick="location.href='deletecargo.php?valor=<?php echo $rov['id_cargo'] ?>'" class="btn btn-sm btn-danger">Eliminar</button>
                </div>
              </div>
            </div>
          </div>
