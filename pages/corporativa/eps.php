        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Gestion de EPS</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="#"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item"><a href="#">EPS</a></li>
            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <div class="row icon-examples">
				...
				<button  type="button" class="btn btn-primary btn-lg btn-block" onclick="location.href=&quot;nuevoeps.php&quot;">
                ...
                <div style="padding-top: 15px;"class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-warning btn-lg btn-block" onclick="location.href=&quot;modificareps.php&quot;">
				 <div>
                      <i class="ni ni-settings-gear-65 "></i>
                      <span>Modificar EPS</span>
                    </div>
				  </button>
                </div>
				
				 <div style="padding-top: 15px;" class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-danger btn-lg btn-block" onclick="location.href=&quot;eliminareps.php&quot;">
				  <div>
                      <i class="ni ni-fat-remove "></i>
                      <span>Eliminar EPS</span>
                    </div>
				  </button>
                </div>
...
$quera="SELECT * FROM eps WHERE state_fsc='activo' ORDER BY `eps`.`id_eps` DESC";
              ...
              <div class="row align-items-center">
                <div class="col-auto">
                  ...
                  <a href="#" id="avata" class="avatar avatar-xl rounded-circle">
                    <img src="../../uploads/eps/<?php echo $foto;?>">
                  </a>
                </div>
                <div class="col ml--2">
                  <h4 class="mb-0">
                ...
                <div class="col-auto">
                  <button type="button" onclick="location.href='vereps.php?valor=<?php echo $rov['id_eps'] ?>'" class="btn btn-sm btn-success">Ver</button>
                </div>
              </div>
            </div>
          </div>
