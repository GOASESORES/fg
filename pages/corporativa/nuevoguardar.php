...
$que="INSERT INTO `cliente`(`id_cliente`, `tipo`, `nombre`, `nit`, `pertenece_grupo`, `grupo`, `representante`,
 `direccion`, `ciudad`, `telefono`, `sector`, `trabajadores`, `no_centro`, `arl`, `logo`, `permisos`, `state_fsc`, `created_by`, `created_at`) 
 VALUES 
                      (NULL,'$dato1','$dato2','$dato3','$dato4','$dato100','$dato5','$dato6','$dato7','$dato8','$dato9','$dato10','$dato14','$dato11','$datoimagen','$dato12','activo','28','$hoy')";
 ...
 $dato18=$_POST['telefonoa'];
 $dato19=$_POST['celulara'];
 $dato20=$_POST['cumplea'];
 $dato21=$_POST['password'];
 $hash = md5 ($dato21);
 $dato22=$_POST['permiso1'];

$quera="SELECT * FROM cliente ORDER BY `cliente`.`id_cliente` DESC";
$caa=$mysqli->query($quera);
$rov=$caa->fetch_assoc();
$empresa=$rov['id_cliente'];
...
VALUES (NULL,'$dato13','$dato14','$dato17','$hash','$dato15','$dato16','$dato18','$dato19','$dato20','administrador','$datoimagen',NULL,NULL,NULL,'$dato22','$empresa','inactivo','0','0','0','0','0','$dato15')";
...
?>
 <script> 
       Swal.fire({
  title: 'Correcto!',
  text: 'Se a creado un nuevo cliente',
  icon: 'success',
