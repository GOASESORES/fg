...
$queb="INSERT INTO `eps`(`id_eps`, `codigo`, `nombre`, `descripcion`, `empresa`, `state_fsc`, 
`created_by`, `created_at`, `logo`) VALUES (NULL,'$dato1','$dato2','$dato4','$empresa','activo','0','0','$datoimagen')";
