        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Gestion de grupos</h6>
            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <div class="row icon-examples">
				...
				<button  type="button" class="btn btn-primary btn-lg btn-block" onclick="location.href=&quot;nuevogrupo.php&quot;">
                ...
                <div style="padding-top: 15px;"class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-warning btn-lg btn-block" onclick="location.href=&quot;modificargrupo.php&quot;">
				 <div>
                      <i class="ni ni-settings-gear-65 "></i>
				 ...
				 <div style="padding-top: 15px;" class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-success btn-lg btn-block" onclick="location.href=&quot;grupos.php&quot;">
				  <div>
                      <i class="ni ni-single-02 "></i>
                      <span>Ver grupo</span>
                    </div>
              ...
              <div class="row align-items-center">
                <div class="col-auto">
                  ...
                  <a href="#" id="foto" class="avatar avatar-xl  ">
                    <img src="../../assets/img/trabajo-en-equipo.svg">
                  </a>
                </div>
                <div class="col ml--2">
                  <h4 class="mb-0">
...
#qr {
    ...
    justify-content: center;
                  ...
                  <button type="button" onclick="location.href='deletegrupo.php?valor=<?php echo $rov['id_grupo'] ?>'" class="btn btn-sm btn-danger">Eliminar</button>
                </div>
              </div>
            </div>
          </div>
