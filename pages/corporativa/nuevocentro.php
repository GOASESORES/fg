 ...
 <?php require('../general/nav.php')?>
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Nuevo centro</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="../dashboards/dashboard,php"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item"><a href="centro.php">Nuevo</a></li>
          ...
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <div class="card-header">
			   ...
			   <form class="needs-validation" novalidate enctype="multipart/form-data" method="post"  action="nuevoguardarcentro.php">
              <!-- Card body -->
              <div class="card-body">
  ...
  <div class="form-row">
					...
					<div class="col-md-4 mb-3">
                      ...
                      <input name="nombre" type="text" class="form-control" id="validationCustom02" placeholder="Apellidos"  required>
                      
                    </div>
					 <div class="col-md-4 mb-3">
                      <label class="form-control-label" for="validationCustom02">C. costos</label>
                      <input name="costos" type="text" class="form-control" id="validationCustom02" placeholder="Nombre"  required>
                      
                    </div>
					 <div class="col-md-4 mb-3">
                      <label class="form-control-label" for="validationCustom02">Ciudad</label>
                      <input name="ciudad" type="text" class="form-control" id="validationCustom02" placeholder="Nombre"  required>
                      
                    </div>
					 <div class="col-md-4 mb-3">
                      <label class="form-control-label" for="validationCustom02">Direccion</label>
                      <input name="direccion" type="text" class="form-control" id="validationCustom02" placeholder="Nombre"  required>
                      
                    </div>
					<div class="col-md-4 mb-3">
                      <label class="form-control-label" for="validationCustom02">responsable</label>
                      <input name="responsable" type="text" placeholder="Responsable" class="form-control" id="validationCustom02"   required>
...
<?php } ?>
                  ...
                  <button class="btn btn-primary btn-lg btn-block"  type="submit">AGREGAR CENTRO</button>
                </form>
              </div>
            </div>
