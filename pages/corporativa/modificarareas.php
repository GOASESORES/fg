        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Modificar areas</h6>
              ...
              <div class="card-body">
               ...
               <div class="row icon-examples">
                ...
                <div style="padding-top: 15px;"class="col-lg-4 col-md-6">
				 ...
				 <div style="padding-top: 15px;" class="col-lg-4 col-md-6">
                  <button type="button" class="btn btn-danger btn-lg btn-block" onclick="location.href=&quot;eliminarareas.php&quot;">
				  <div>
                      <i class="ni ni-fat-remove "></i>
                      <span>Eliminar area</span>
                    </div>
				  </button>
                </div>
...
#qr {
    ...
    justify-content: center;
                  ...
                  <button type="button" onclick="location.href='editarareas.php?valor=<?php echo $rov['id_area'] ?>'" class="btn btn-sm btn-warning">Modificar</button>
                </div>
              </div>
            </div>
          </div>
